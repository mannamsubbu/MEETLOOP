    ...
    <div className='min-h-screen relative bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Connect instantly with friends and your network</p>
        </div>
        {/* Connected Users */}
        <div className='flex flex-col gap-3'>
          {dummyConnectionsData.map((user) => (
            <div key={user._id} className='max-w-xl flex items-start gap-4 p-4 bg-white shadow rounded-xl'>
              <img src={user.profile_picture} alt="" className='size-12 rounded-full mx-auto' />
