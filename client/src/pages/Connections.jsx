...
const Connections = () => {
  ...
  return (
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-suto p-6'>

        {/*Title*/}
        <div className='mb-8'>
          <h1 className='text-3xl font-bold text-slate-900 mb-2'>Connections</h1>
          <p className='text-slate-600'>Build your network and stay connected with people who matter</p>
        </div>
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                  ...
                  }
                  {
                    currentTab === 'Connections' && (
                      ...
                      hover:bg-slate-200 text-slate-800 active:scale-95 transition cursor-pointer flex items-center justify-center gap-1'>
