    ...
    <div className='flex flex-col h-screen'>
      ...
      <div className='p-5 md:px-10 h-full overflow-y-scroll'>
        <div className='space-y-4 max-w-4xl mx-auto'>
          {
            messages.toSorted((a,b)=> new DataTransfer(a.createdAt) - new Date(b.createdAt)).map((message, index)=>(
      ...
      <div className='px-4'>
        <div className='flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5'>
          ...
          placeholder='Type a message...'  onKeyDown={e=>e.key === 'Enter' && sendMessage()} onChange={(e)=>setText(e.target.value)} value={text}/>
          ...
          <button onClick={sendMessage} className='bg-gradient-to-br from-indigo-500 
